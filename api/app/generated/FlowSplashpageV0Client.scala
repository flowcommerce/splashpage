 ...
 * Service version: 0.1.94
 * apidoc:0.11.37 http://www.apidoc.me/flow/splashpage/0.1.94/play_2_4_client
 */
...
package io.flow.splashpage.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.37 http://www.apidoc.me/flow/splashpage/0.1.94/play_2_4_client"
    val Version = "0.1.94"
    val VersionMajor = 0
    ...
    object Subscriptions extends Subscriptions {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/subscriptions", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 422 => throw new io.flow.splashpage.v0.errors.ValidationErrorResponse(r)
  ...
  package errors {
    ...
    case class ValidationErrorResponse(
      ...
      lazy val validationError = _root_.io.flow.splashpage.v0.Client.parseJson("io.flow.error.v0.models.ValidationError", response, _.validate[io.flow.error.v0.models.ValidationError])
    }
