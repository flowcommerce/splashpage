 ...
 * apidoc:0.11.32 http://www.apidoc.me/flow/common/0.0.47/play_2_x_json
 */
package io.flow.common.v0.models {
  ...
  object Environment {
    ...
    /**
     * In test, no external services (e.g. payments) will generate real transactions
     */
    case object Test extends Environment { override def toString = "test" }
    /**
