 ...
 * Service version: 0.0.75
 * apidoc:0.11.33 http://www.apidoc.me/flow/common/0.0.75/play_2_x_json
 */
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsCommonItemSummary: play.api.libs.json.Reads[ItemSummary] = {
      (
    ...
    def jsObjectItemSummary(obj: io.flow.common.v0.models.ItemSummary) = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesCommonItemSummary: play.api.libs.json.Writes[ItemSummary] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.ItemSummary] {
        def writes(obj: io.flow.common.v0.models.ItemSummary) = {
