 ...
 * apidoc:0.11.33 http://www.apidoc.me/flow/common/0.0.65/anorm_2_x_parsers
 */
package io.flow.common.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqCommonItemSummary: Column[Seq[_root_.io.flow.common.v0.models.ItemSummary]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.ItemSummary]] }
    implicit val columnToMapCommonItemSummary: Column[Map[String, _root_.io.flow.common.v0.models.ItemSummary]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.ItemSummary]] }
