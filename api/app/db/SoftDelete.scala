...
private[db] object SoftDelete {
  ...
  def delete(c: java.sql.Connection, tableName: String, deletedBy: User, guid: String) {
  ...
  def delete(c: java.sql.Connection, tableName: String, deletedBy: User, guid: UUID): Unit = {
  ...
  def delete(c: java.sql.Connection, tableName: String, deletedBy: User, field: (String, Option[String], String)) {
