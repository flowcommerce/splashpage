 ...
 * apidoc:0.9.42 http://localhost:9000/flow/common/0.0.1-dev/play_2_x_json
 */
package io.flow.common.v0.models {
  ...
  object UnitOfMeasurement {
     ...
     * above.
     */
    val all = Seq(Millimeter, Centimeter, Inch, Foot, CubicInch, CubicMeter, Kilogram, Meter, Ounce, Pound)
