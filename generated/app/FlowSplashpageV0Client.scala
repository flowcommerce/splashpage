 ...
 * apidoc:0.11.6 http://www.apidoc.me/flow/splashpage/0.1.3/play_2_4_client
 */
  ...
  package object json {
    ...
    def jsObjectGeo(obj: io.flow.splashpage.v0.models.Geo) = {
      (obj.ipAddress match {
        ...
        case Some(x) => play.api.libs.json.Json.obj("ip_address" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.latitude match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("latitude" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.longitude match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("longitude" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectSubscriptionForm(obj: io.flow.splashpage.v0.models.SubscriptionForm) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("geo" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
package io.flow.splashpage.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.6 http://www.apidoc.me/flow/splashpage/0.1.3/play_2_4_client"
    val Version = "0.1.3"
    val VersionMajor = 0
  ...
  package interfaces {
    ...
    trait Client {
      def healthchecks: io.flow.splashpage.v0.Healthchecks
