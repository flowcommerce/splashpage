 ...
 * apidoc:0.11.11 http://www.apidoc.me/flow/splashpage/0.1.4/play_2_4_client
 */
...
package io.flow.splashpage.v0 {
  ...
  object Constants {
    ...
    val BaseUrl = "http://api.flow.io"
    val Namespace = "io.flow.splashpage.v0"
    val UserAgent = "apidoc:0.11.11 http://www.apidoc.me/flow/splashpage/0.1.4/play_2_4_client"
    val Version = "0.1.4"
    val VersionMajor = 0
  ...
  class Client(
    apiUrl: String = "http://api.flow.io",
