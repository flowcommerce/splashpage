 ...
 * apidoc:0.10.1 http://localhost:9000/flow/splashpage/0.1.1/play_2_4_client
 */
  ...
  package object json {
    ...
    def jsObjectGeo(obj: io.flow.splashpage.v0.models.Geo) = {
      play.api.libs.json.Json.obj(
        "ip_address" -> play.api.libs.json.Json.toJson(obj.ipAddress),
        "latitude" -> play.api.libs.json.Json.toJson(obj.latitude),
        "longitude" -> play.api.libs.json.Json.toJson(obj.longitude)
      )
    }
    ...
    def jsObjectSubscriptionForm(obj: io.flow.splashpage.v0.models.SubscriptionForm) = {
      play.api.libs.json.Json.obj(
        "email" -> play.api.libs.json.JsString(obj.email),
        "publication" -> play.api.libs.json.JsString(obj.publication.toString),
        "geo" -> play.api.libs.json.Json.toJson(obj.geo)
      )
    }
...
package io.flow.splashpage.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.1 http://localhost:9000/flow/splashpage/0.1.1/play_2_4_client"
    val Version = "0.1.1"
    val VersionMajor = 0
