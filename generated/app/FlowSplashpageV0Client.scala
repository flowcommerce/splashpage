 ...
 * apidoc:0.9.42 http://www.apidoc.me/flow/splashpage/0.0.1-dev/play_2_4_client
 */
...
package io.flow.splashpage.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.42 http://www.apidoc.me/flow/splashpage/0.0.1-dev/play_2_4_client"
    ...
    object Subscriptions extends Subscriptions {
      ...
      override def getByGuid(
        ...
        _executeRequest("GET", s"/subscriptions/${guid}").map {
          ...
          case r => throw new io.flow.splashpage.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def deleteByGuid(
        ...
        _executeRequest("DELETE", s"/subscriptions/${guid}").map {
          ...
          case r => throw new io.flow.splashpage.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204")
        }
      }
    }
