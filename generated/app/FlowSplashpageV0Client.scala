 ...
 * apidoc:0.9.48 http://localhost:9000/flow/splashpage/0.0.1-dev/play_2_4_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsSplashpageSubscription: play.api.libs.json.Reads[Subscription] = {
      (
        ...
        (__ \ "geo").read[io.flow.splashpage.v0.models.Geo] and
    ...
    implicit def jsonWritesSplashpageSubscription: play.api.libs.json.Writes[Subscription] = {
      (
        ...
        (__ \ "geo").write[io.flow.splashpage.v0.models.Geo] and
...
package io.flow.splashpage.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.48 http://localhost:9000/flow/splashpage/0.0.1-dev/play_2_4_client"
